...
st.write(
    ...
    > These examples demonstrated how quickly and accurately the pre-trained CNN was able to colorize a wide variety of inputs, from portraits to landscapes to high-resolution photographs, all within a few hundred milliseconds on modern standard hardware.
    """
)
